...
Achievement = namedtuple(
    "Achievement", ["key", "name", "description", "hidden", "players"]
)
...
SPECIES_SHORTNAME_FIXUPS = {"Ke": "Te", "DS": "Ds", "DG": "Dg", "OP": "Op", "Bu": "Gn"}
SPECIES_NAME_FIXUPS = {
...
ACHIEVEMENTS = (
    Achievement(
        "0.19_first",
        "0.19 Tournament: First Place",
        "First place in the 0.19 tournament, May 2016.",
        True,
        ("Yermak",),
    ),
    Achievement(
        "0.19_second",
        "0.19 Tournament: Second Place",
        "Second place in the 0.19 tournament, May 2016.",
        True,
        ("Ultraviolent4",),
    ),
    Achievement(
        "0.19_third",
        "0.19 Tournament: Third Place",
        "Third place in the 0.19 tournament, May 2016.",
        True,
        ("p0werm0de",),
    ),
    Achievement(
        "0.19_clan_first",
        "0.19 Tournament: First Place (Clan)",
    ...
    Achievement(
        "0.19_clan_second",
        "0.19 Tournament: Second Place (Clan)",
        "Part of the second placed clan in the 0.19 tournament, May 2016.",
        True,
        ("Leszczynek", "Enish", "kuniqs", "murphy", "p0werm0de", "vev"),
    ),
    Achievement(
        "0.19_clan_third",
        "0.19 Tournament: Third Place (Clan)",
    ...
    Achievement(
        "0.18_first",
        "0.18 Tournament: First Place",
        "First place in the 0.18 tournament, May 2016.",
        True,
        ("Yermak",),
    ),
    Achievement(
        "0.18_second",
        "0.18 Tournament: Second Place",
        "Second place in the 0.18 tournament, May 2016.",
        True,
        ("Demise",),
    ),
    Achievement(
        "0.18_third",
        "0.18 Tournament: Third Place",
        "Third place in the 0.18 tournament, May 2016.",
        True,
        ("Ultraviolent4",),
    ),
    Achievement(
        "0.18_clan_first",
        "0.18 Tournament: First Place (Clan)",
        "Part of the first placed clan in the 0.18 tournament, May 2016.",
        True,
        ("WalkerBoh", "MorganLeah", "Snack", "moose", "n1000", "Lasty"),
    ),
    Achievement(
        "0.18_clan_second",
        "0.18 Tournament: Second Place (Clan)",
    ...
    Achievement(
        "0.18_clan_third",
        "0.18 Tournament: Third Place (Clan)",
    ...
    Achievement(
        "0.17_first",
        "0.17 Tournament: First Place",
        "First place in the 0.17 tournament, November 2015.",
        True,
        ("cosmonaut",),
    ),
    Achievement(
        "0.17_second",
        "0.17 Tournament: Second Place",
        "Second place in the 0.17 tournament, November 2015.",
        True,
        ("johnnyzero",),
    ),
    Achievement(
        "0.17_third",
        "0.17 Tournament: Third Place",
        "Third place in the 0.17 tournament, November 2015.",
        True,
        ("iafm",),
    ),
    Achievement(
        "0.17_clan_first",
        "0.17 Tournament: First Place (Clan)",
    ...
    Achievement(
        "0.17_clan_second",
        "0.17 Tournament: Second Place (Clan)",
        "Part of the second placed clan in the 0.17 tournament, November 2015.",
        True,
        ("Vidiiot", "banto", "Wizzzargh", "ayayaya", "bart", "emiel"),
    ),
    Achievement(
        "0.17_clan_third",
        "0.17 Tournament: Third Place (Clan)",
    ...
    Achievement(
        "0.16_first",
        "0.16 Tournament: First Place",
        "First place in the 0.16 tournament, May 2015.",
        True,
        ("DrKe",),
    ),
    Achievement(
        "0.16_second",
        "0.16 Tournament: Second Place",
        "Second place in the 0.16 tournament, May 2015.",
        True,
        ("Zooty",),
    ),
    Achievement(
        "0.16_third",
        "0.16 Tournament: Third Place",
        "Third place in the 0.16 tournament, May 2015.",
        True,
        ("Yermak",),
    ),
    Achievement(
        "0.16_clan_first",
        "0.16 Tournament: First Place (Clan)",
    ...
    Achievement(
        "0.16_clan_second",
        "0.16 Tournament: Second Place (Clan)",
    ...
    Achievement(
        "0.16_clan_third",
        "0.16 Tournament: Third Place (Clan)",
    ...
    Achievement(
        "0.15_first",
        "0.15 Tournament: First Place",
        "First place in the 0.15 tournament, August 2014.",
        True,
        ("Tolias",),
    ),
    Achievement(
        "0.15_second",
        "0.15 Tournament: Second Place",
        "Second place in the 0.15 tournament, August 2014.",
        True,
        ("Yermak",),
    ),
    Achievement(
        "0.15_third",
        "0.15 Tournament: Third Place",
        "Third place in the 0.15 tournament, August 2014.",
        True,
        ("johnnyzero",),
    ),
    Achievement(
        "0.15_clan_first",
        "0.15 Tournament: First Place (Clan)",
        "Part of the first placed clan in the 0.15 tournament, August 2014.",
        True,
        ("Tolias", "MrPlanck", "Tabstorm", "Tedronai", "Yermak", "magicpoints"),
    ),
    Achievement(
        "0.15_clan_second",
        "0.15 Tournament: Second Place (Clan)",
        "Part of the second placed clan in the 0.15 tournament, August 2014.",
        True,
        ("DrKe", "Roarke", "Sky", "agentgt", "johnnyzero", "perunasaurus"),
    ),
    Achievement(
        "0.15_clan_third",
        "0.15 Tournament: Third Place (Clan)",
    ...
    Achievement(
        "0.14_first",
        "0.14 Tournament: First Place",
        "First place in the 0.14 tournament, April 2014.",
        True,
        ("Tolias",),
    ),
    Achievement(
        "0.14_second",
        "0.14 Tournament: Second Place",
        "Second place in the 0.14 tournament, April 2014.",
        True,
        ("johnnyzero",),
    ),
    Achievement(
        "0.14_third",
        "0.14 Tournament: Third Place",
        "Third place in the 0.14 tournament, April 2014.",
        True,
        ("Yermak",),
    ),
    Achievement(
        "0.14_clan_first",
        "0.14 Tournament: First Place (Clan)",
        "Part of the first placed clan in the 0.14 tournament, April 2014.",
        True,
        ("ebarrett", "Ayutzia", "Ragdoll", "ToastyP", "jeanjacques", "johnnyzero"),
    ),
    Achievement(
        "0.14_clan_second",
        "0.14 Tournament: Second Place (Clan)",
        "Part of the second placed clan in the 0.14 tournament, April 2014.",
        True,
        ("Yermak", "4thArraOfDagon", "BLOAX", "Tolias", "Vidiiot", "hurdos"),
    ),
    Achievement(
        "0.14_clan_third",
        "0.14 Tournament: Third Place (Clan)",
        "Part of the third placed clan in the 0.14 tournament, April 2014.",
        True,
        ("DrKe", "Roarke", "ackack", "agentgt", "cszzzz", "wheals"),
    ),
    Achievement(
        "0.13_first",
        "0.13 Tournament: First Place",
        "First place in the 0.13 tournament, October 2013.",
        True,
        ("bmfx",),
    ),
    Achievement(
        "0.13_second",
        "0.13 Tournament: Second Place",
        "Second place in the 0.13 tournament, October 2013.",
        True,
        ("78291",),
    ),
    Achievement(
        "0.13_third",
        "0.13 Tournament: Third Place",
        "Third place in the 0.13 tournament, October 2013.",
        True,
        ("elliptic",),
    ),
    Achievement(
        "0.13_clan_first",
        "0.13 Tournament: First Place (Clan)",
        "Part of the first placed clan in the 0.13 tournament, October 2013.",
        True,
        ("dck", "Basil", "Implojin", "Infected", "Sar", "pubby"),
    ),
    Achievement(
        "0.13_clan_second",
        "0.13 Tournament: Second Place (Clan)",
        "Part of the second placed clan in the 0.13 tournament, October 2013.",
        True,
        ("WalkerBoh", "Glenstorm", "MorganLeah", "Snack", "rast", "rzimodnar"),
    ),
    Achievement(
        "0.13_clan_third",
        "0.13 Tournament: Third Place (Clan)",
        "Part of the third placed clan in the 0.13 tournament, October 2013.",
        True,
        ("n1000", "blazinghand", "bmfx", "ogaz", "rchandra", "tewe"),
    ),
    Achievement(
        "0.12_first",
        "0.12 Tournament: First Place",
        "First place in the 0.12 tournament, May 2013.",
        True,
        ("jeanjacques",),
    ),
    Achievement(
        "0.12_second",
        "0.12 Tournament: Second Place",
        "Second place in the 0.12 tournament, May 2013.",
        True,
        ("elliptic",),
    ),
    Achievement(
        "0.12_third",
        "0.12 Tournament: Third Place",
        "Third place in the 0.12 tournament, May 2013.",
        True,
        ("Tolias",),
    ),
    Achievement(
        "0.12_clan_first",
        "0.12 Tournament: First Place (Clan)",
    ...
    Achievement(
        "0.12_clan_second",
        "0.12 Tournament: Second Place (Clan)",
        "Part of the second placed clan in the 0.12 tournament, May 2013.",
        True,
        ("elliptic", "MarvinPA", "mikee", "pivotal", "reid", "simm"),
    ),
    Achievement(
        "0.12_clan_third",
        "0.12 Tournament: Third Place (Clan)",
    ...
    Achievement(
        "0.11_first",
        "0.11 Tournament: First Place",
        "First place in the 0.11 tournament, November 2012.",
        True,
        ("theglow",),
    ),
    Achievement(
        "0.11_second",
        "0.11 Tournament: Second Place",
        "Second place in the 0.11 tournament, November 2012.",
        True,
        ("jeanjacques",),
    ),
    Achievement(
        "0.11_third",
        "0.11 Tournament: Third Place",
        "Third place in the 0.11 tournament, November 2012.",
        True,
        ("bmfx",),
    ),
    Achievement(
        "0.11_clan_first",
        "0.11 Tournament: First Place (Clan)",
    ...
    Achievement(
        "0.11_clan_second",
        "0.11 Tournament: Second Place (Clan)",
        "Part of the second placed clan in the 0.11 tournament, November 2012.",
        True,
        ("Nomi", "78291", "Grimm", "MarvinPA", "bmfx", "hyperelliptic"),
    ),
    Achievement(
        "0.11_clan_third",
        "0.11 Tournament: Third Place (Clan)",
    ...
    Achievement(
        "0.10_first",
        "0.10 Tournament: First Place",
        "First place in the 0.10 tournament, March 2012.",
        True,
        ("elliptic",),
    ),
    Achievement(
        "0.10_second",
        "0.10 Tournament: Second Place",
        "Second place in the 0.10 tournament, March 2012.",
        True,
        ("jeanjacques",),
    ),
    Achievement(
        "0.10_third",
        "0.10 Tournament: Third Place",
        "Third place in the 0.10 tournament, March 2012.",
        True,
        ("pivotal",),
    ),
    Achievement(
        "0.10_clan_first",
        "0.10 Tournament: First Place (Clan)",
    ...
    Achievement(
        "0.10_clan_second",
        "0.10 Tournament: Second Place (Clan)",
        "Part of the second placed clan in the 0.10 tournament, March 2012.",
        True,
        ("Ragdoll", "Elynae", "caracal", "jeanjacques", "jle", "reid"),
    ),
    Achievement(
        "0.10_clan_third",
        "0.10 Tournament: Third Place (Clan)",
        "Part of the third placed clan in the 0.10 tournament, March 2012.",
        True,
        ("evilmike", "GreatZebu", "Lawman0", "magistern", "ophanim", "pivotal"),
    ),
    Achievement(
        "0.9_first",
        "0.9 Tournament: First Place",
        "First place in the 0.9 tournament, August 2011.",
        True,
        ("theglow",),
    ),
    Achievement(
        "0.9_second",
        "0.9 Tournament: Second Place",
        "Second place in the 0.9 tournament, August 2011.",
        True,
        ("mikee",),
    ),
    Achievement(
        "0.9_third",
        "0.9 Tournament: Third Place",
        "Third place in the 0.9 tournament, August 2011.",
        True,
        ("jeanjacques",),
    ),
    Achievement(
        "0.9_clan_first",
        "0.9 Tournament: First Place (Clan)",
    ...
    Achievement(
        "0.9_clan_second",
        "0.9 Tournament: Second Place (Clan)",
        "Part of the second placed clan in the 0.9 tournament, August 2011.",
        True,
        ("evilmike", "Jordan7hm", "Lawman0", "Shovelmint", "heteroy", "theglow"),
    ),
    Achievement(
        "0.9_clan_third",
        "0.9 Tournament: Third Place (Clan)",
    ...
    Achievement(
        "0.8_first",
        "0.8 Tournament: First Place",
        "First place in the 0.8 tournament, May 2011.",
        True,
        ("mikee",),
    ),
    Achievement(
        "0.8_second",
        "0.8 Tournament: Second Place",
        "Second place in the 0.8 tournament, May 2011.",
        True,
        ("elliptic",),
    ),
    Achievement(
        "0.8_third",
        "0.8 Tournament: Third Place",
        "Third place in the 0.8 tournament, May 2011.",
        True,
        ("casmith789",),
    ),
    Achievement(
        "0.8_clan_first",
        "0.8 Tournament: First Place (Clan)",
    ...
    Achievement(
        "0.8_clan_second",
        "0.8 Tournament: Second Place (Clan)",
    ...
    Achievement(
        "0.8_clan_third",
        "0.8 Tournament: Third Place (Clan)",
    ...
    Achievement(
        "0.7_first",
        "0.7 Tournament: First Place",
        "First place in the 0.7 tournament, August 2010.",
        True,
        ("elliptic",),
    ),
    Achievement(
        "0.7_second",
        "0.7 Tournament: Second Place",
        "Second place in the 0.7 tournament, August 2010.",
        True,
        ("Jaeger",),
    ),
    Achievement(
        "0.7_third",
        "0.7 Tournament: Third Place",
        "Third place in the 0.7 tournament, August 2010.",
        True,
        ("78291",),
    ),
    Achievement(
        "0.7_clan_first",
        "0.7 Tournament: First Place (Clan)",
    ...
    Achievement(
        "0.7_clan_second",
        "0.7 Tournament: Second Place (Clan)",
        "Part of the second placed clan in the 0.7 tournament, August 2010.",
        True,
        ("Jaeger", "Sastopher", "ToastyP", "henryci", "nmf", "reid"),
    ),
    Achievement(
        "0.7_clan_third",
        "0.7 Tournament: Third Place (Clan)",
        "Part of the third placed clan in the 0.7 tournament, August 2010.",
        True,
        ("valrus", "Morri", "PigVomit", "daftfad", "herself", "nrook"),
    ),
    Achievement(
        "0.5_first",
        "0.5 Tournament: First Place",
        "First place in the 0.5 tournament, August 2009.",
        True,
        ("78291",),
    ),
    Achievement(
        "0.5_second",
        "0.5 Tournament: Second Place",
        "Second place in the 0.5 tournament, August 2009.",
        True,
        ("mikee",),
    ),
    Achievement(
        "0.5_third",
        "0.5 Tournament: Third Place",
        "Third place in the 0.5 tournament, August 2009.",
        True,
        ("elliptic",),
    ),
    Achievement(
        "0.5_clan_first",
        "0.5 Tournament: First Place (Clan)",
        "Part of the first placed clan in the 0.5 tournament, August 2009.",
        True,
        ("Jeff", "Grivan", "MadDasher", "heteroy", "mikee", "rob"),
    ),
    Achievement(
        "0.5_clan_second",
        "0.5 Tournament: Second Place (Clan)",
        "Part of the second placed clan in the 0.5 tournament, August 2009.",
        True,
        ("doy", "78291", "Grimm", "Stabwound", "cbus", "elliptic"),
    ),
    Achievement(
        "0.5_clan_third",
        "0.5 Tournament: Third Place (Clan)",
        "Part of the third placed clan in the 0.5 tournament, August 2009.",
        True,
        ("LordSloth", "CatEater", "ZaurenTour", "eternal", "pointless", "trucutru"),
    ),
    Achievement(
        "0.4_first",
        "0.4 Tournament: First Place",
        "First place in the 0.4 tournament, August 2008.",
        True,
        ("Stabwound",),
    ),
    Achievement(
        "0.4_second",
        "0.4 Tournament: Second Place",
        "Second place in the 0.4 tournament, August 2008.",
        True,
        ("78291",),
    ),
    Achievement(
        "0.4_third",
        "0.4 Tournament: Third Place",
        "Third place in the 0.4 tournament, August 2008.",
        True,
        ("Dingir",),
    ),
    Achievement(
        "0.4_clan_first",
        "0.4 Tournament: First Place (Clan)",
        "Part of the first placed clan in the 0.4 tournament, August 2008.",
        True,
        ("doy", "78291", "Stabwound", "cbus", "duke", "wasp"),
    ),
    Achievement(
        "0.4_clan_second",
        "0.4 Tournament: Second Place (Clan)",
        "Part of the second placed clan in the 0.4 tournament, August 2008.",
        True,
        ("rax", "Enne", "Iaido", "Shiori", "modicum", "violetj"),
    ),
    Achievement(
        "0.4_clan_third",
        "0.4 Tournament: Third Place (Clan)",
        "Part of the third placed clan in the 0.4 tournament, August 2008.",
        True,
        ("Eronarn", "Foggy", "Tag", "Voiks", "eternal", "pointless"),
    ),
)
